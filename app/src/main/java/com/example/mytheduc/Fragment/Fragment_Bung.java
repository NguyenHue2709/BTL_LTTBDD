...
public class Fragment_Bung extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bungPlanetArrayList.add(new BungPlanet("3. GẶP BỤNG CHÉO", R.drawable.gapbungcheo,"Ngồi trên sàn với đầu gối cong, bàn chân đặt xuống mặt sàn và lựng nghiêng về sau. Sau đó nắm hai tay với nhau và xoay vặn từ bên này sang bên kia. Bài tập này tập cho cơ liên sườn"));
